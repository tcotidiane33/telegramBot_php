    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Ajouter un Livre</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="author" class="col-sm-3 control-label">Auteur</label>
                ...
                <div class="form-group">
                    <label for="montant" class="col-sm-3 control-label">Prix</label>

                    <div class="col-sm-9">
                      <input type="text" class="form-control" placeholder="montant" id="montant" name="montant">
                    </div>
                </div>
                <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	...
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_title" class="col-sm-3 control-label">Titre</label>
                ...
                <div class="form-group">
                    <label for="edit_author" class="col-sm-3 control-label">Auteur</label>
                ...
                <div class="form-group">
                    <label for="edit_publisher" class="col-sm-3 control-label">Editeur</label>
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">Date de Publication</label>
